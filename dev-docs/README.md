...
This directory contains maintainer/contributor-facing documentation:
- architecture notes
- implementation specs
- internal runbooks
- design and backlog documents

These docs may include planned or partially implemented behavior.
