...
- Implemented providers: **OpenAI / Anthropic / OpenRouter / Moonshot / Z.ai**
...
- Provider adapter layer (OpenAI/Anthropic/OpenRouter/Moonshot/Z.ai implemented, Gemini planned)
...
## 6. Providers（OpenAI / Anthropic / OpenRouter / Moonshot / Z.ai implemented, Gemini planned）
...
Detailed specifications for each function are summarized in `dev-docs/specs/`.

- `dev-docs/specs/core-types.md` (common type/compatibility definition)
...
- `dev-docs/specs/providers.md` (OpenAI/Anthropic/OpenRouter/Moonshot/Z.ai/Gemini adapter/serializer policy)
...
- `dev-docs/specs/testing.md` (Test order that can be implemented while learning)
- `dev-docs/specs/implementation-plan.md` (implementation order and acceptance)
