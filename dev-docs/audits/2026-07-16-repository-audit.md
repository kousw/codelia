...
| AUD-018 | **Resolved 2026-08-01:** Public LLM retry options were no-ops | `Agent` now normalizes the public retry/deadline options and routes interactive model steps through the shared abortable coordinator. Deterministic tests cover attempts, wait hints, cancellation, deadlines, and progress events. |
