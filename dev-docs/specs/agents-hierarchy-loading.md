...
- When trimming the tool output of `dev-docs/specs/context-management.md`, clarify the handling so that `<system-reminder>` is not missing (detailed in a separate PR).
---
