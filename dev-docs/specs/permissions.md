...
Approval mode resolution/storage is defined in `dev-docs/specs/approval-mode.md`.
...
> Note: Detailed precedence and storage design are defined in `dev-docs/specs/approval-mode.md`.
