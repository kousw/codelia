...
- update `dev-docs/specs/ui-protocol.md` method list and request section
- update `dev-docs/specs/tui-operation-reference.md` with command surface note
...
- `dev-docs/specs/tui-operation-reference.md`
- `dev-docs/specs/tools.md`
