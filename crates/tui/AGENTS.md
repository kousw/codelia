...
- Successful terminal shell results keep the detail area output-focused: execution time is appended to the summary, while redundant `Key` / `Exit code` / `Output:` detail labels are hidden.
