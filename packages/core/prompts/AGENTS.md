...
- Keep `web_search` guidance optional and high-level: allow considering it for uncertain/outdated external knowledge, but do not make it a blanket substitute for local inspection and verification.
